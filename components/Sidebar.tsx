  ...
  return (
    <>
      ...
      <motion.aside
        ...
        className="fixed top-0 left-0 h-full w-80 bg-card border-r border-border z-50 flex flex-col lg:hidden"
      >
        {/* Header */}
      ...
      <aside className="hidden lg:flex fixed top-0 left-0 h-full w-80 bg-card border-r border-border z-50 flex flex-col">
        {/* Header */}
        <div className="p-6 border-b border-border">
          <h1 className="text-2xl font-bold text-accent mb-4">Squad</h1>
          <p className="text-sm text-muted-foreground">
            Real-time team tracking
          </p>
        </div>
